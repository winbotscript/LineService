            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _ in range(elem584):
                        elem585 = ChannelNotificationSetting()
                        elem585.read(iprot)
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _ in range(elem587):
                        elem588 = iprot.readString()
                        self.channelIds.append(elem588)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class issueRequestTokenWithAuthScheme_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _ in range(elem590):
                        ...
                        self.authScheme.append(elem591)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.authScheme is not None:
            ...
            for elem592 in self.authScheme:
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _ in range(elem593):
                        elem594 = ChannelIdWithLastUpdated()
                        elem594.read(iprot)
                        self.channelIds.append(elem594)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _ in range(elem596):
                        elem597 = iprot.readString()
                        self.success.append(elem597)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _ in range(elem599):
                        elem600 = ChannelNotificationSetting()
                        elem600.read(iprot)
                        self.setting.append(elem600)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
