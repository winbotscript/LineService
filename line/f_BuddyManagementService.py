    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    self.userMids = []
                    (_, elem450) = iprot.readListBegin()
                    for _ in range(elem450):
                        elem451 = iprot.readString()
                        self.userMids.append(elem451)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class commitSendMessagesToAll_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _ in range(elem453):
                        ...
                        self.requestIdList.append(elem454)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.requestIdList is not None:
            ...
            for elem455 in self.requestIdList:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _ in range(elem456):
                        elem457 = SendBuddyMessageResult()
                        elem457.read(iprot)
                        self.success.append(elem457)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _ in range(elem459):
                        elem460 = iprot.readString()
                        self.requestIdList.append(elem460)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    self.mids = []
                    (_, elem461) = iprot.readListBegin()
                    for _ in range(elem461):
                        elem462 = iprot.readString()
                        self.mids.append(elem462)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _ in range(elem465):
                        elem466 = SendBuddyMessageResult()
                        elem466.read(iprot)
                        self.success.append(elem466)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
class registerBuddy_args(object):
    ...
    def write(self, oprot):
        ...
        if self.settings is not None:
            ...
            for elem484, elem483 in self.settings.items():
                oprot.writeString(elem484)
                oprot.writeString(elem483)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class updateBuddyAdminProfileAttribute_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _ in range(elem500):
                        ...
                        self.attributes[elem502] = elem501
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for elem504, elem503 in self.attributes.items():
                oprot.writeString(elem504)
                oprot.writeString(elem503)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class updateBuddyProfileAttributes_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    self.attributes = {}
                    (_, _, elem505) = iprot.readMapBegin()
                    for _ in range(elem505):
                        elem507 = iprot.readString()
                        elem506 = iprot.readString()
                        self.attributes[elem507] = elem506
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            oprot.writeFieldBegin('attributes', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.attributes))
            for elem509, elem508 in self.attributes.items():
                oprot.writeString(elem509)
                oprot.writeString(elem508)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class updateBuddyProfileAttributesAsync_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    self.attributes = {}
                    (_, _, elem510) = iprot.readMapBegin()
                    for _ in range(elem510):
                        elem512 = iprot.readString()
                        elem511 = iprot.readString()
                        self.attributes[elem512] = elem511
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            oprot.writeFieldBegin('attributes', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.attributes))
            for elem514, elem513 in self.attributes.items():
                oprot.writeString(elem514)
                oprot.writeString(elem513)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class updateBuddySettings_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 2:
                if ftype == TType.MAP:
                    self.settings = {}
                    (_, _, elem515) = iprot.readMapBegin()
                    for _ in range(elem515):
                        elem517 = iprot.readString()
                        elem516 = iprot.readString()
                        self.settings[elem517] = elem516
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.settings is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.settings))
            for elem519, elem518 in self.settings.items():
                oprot.writeString(elem519)
                oprot.writeString(elem518)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
