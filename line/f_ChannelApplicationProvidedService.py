            ...
            if fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _ in range(elem546):
                        elem547 = iprot.readString()
                        self.ids.append(elem547)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _ in range(elem573):
                        elem574 = SimpleChannelContact()
                        elem574.read(iprot)
                        self.success.append(elem574)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
class getUserIdentities_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    self.success = {}
                    (_, _, elem576) = iprot.readMapBegin()
                    for _ in range(elem576):
                        elem578 = RegistrationType(iprot.readI32())
                        elem577 = iprot.readString()
                        self.success[elem578] = elem577
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for elem580, elem579 in self.success.items():
                oprot.writeI32(elem580)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    self.success = []
                    (_, elem581) = iprot.readListBegin()
                    for _ in range(elem581):
                        elem582 = iprot.readString()
                        self.success.append(elem582)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
